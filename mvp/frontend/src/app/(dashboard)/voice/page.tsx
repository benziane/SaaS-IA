    ...
    <div className="p-5 space-y-5 animate-enter">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-[var(--text-mid)]">AI voice cloning, text-to-speech, and automatic dubbing</p>
        </div>
      </div>
        ...
        <div className="md:col-span-5">
          <div className="surface-card p-5">
            ...
            {isLoading ? <Skeleton className="h-[300px] w-full" /> : !syntheses?.length ? (
              ...
              syntheses.map((s) => (
                <div key={s.id} className="surface-card p-3 mb-2 border border-[var(--border)]">
