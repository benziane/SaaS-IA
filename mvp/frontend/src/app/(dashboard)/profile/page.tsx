    ...
    <div className="p-5 space-y-5 animate-enter">
      ...
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-[var(--bg-elevated)] border border-[var(--border)] shrink-0">
          <UserCircle className="h-5 w-5 text-[var(--accent)]" />
        </div>
        <div>
          <h1 className="text-xl font-bold text-[var(--text-high)]">Profile Settings</h1>
          <p className="text-xs text-[var(--text-mid)]">Account settings and preferences</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
        ...
        <div className="md:col-span-4">
          <div className="surface-card p-5 h-full">
            <h2 className="text-base font-semibold text-[var(--text-high)] mb-1">Account Information</h2>
        ...
        <div className="md:col-span-8">
          <div className="flex flex-col gap-5">
            ...
            <div className="surface-card p-5">
              <h2 className="text-base font-semibold text-[var(--text-high)] mb-1">Edit Profile</h2>
              <Separator className="mb-4" />
              <form
            ...
            <div className="surface-card p-5">
              <h2 className="text-base font-semibold text-[var(--text-high)] mb-1">Change Password</h2>
              <Separator className="mb-4" />
              <form
